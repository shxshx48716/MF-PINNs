...
filename_result = "Result_mywork_1.txt"
...
print(f"Result_mywork_1,{now_now}\n")

with open(filename_result, "w") as f:
    f.write(f"Result_mywork_1\n  {now_now}\n")
...
class PhysicsInformedNN:
    ...
    def myplot(x_s, y_s, u_s, v_s, p_s, x_d, y_d, u_d, v_d, p_d, num_boundary):
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('u_s_pred_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('u_s_true_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('u_s_error_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('v_s_pred_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('v_s_true_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('v_s_error_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('p_s_pred_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('p_s_true_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([0.0, 1.0])
        plt.tight_layout()
        plt.savefig('p_s_error_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('u_d_pred_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('u_d_true_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('u_d_error_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('v_d_pred_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('v_d_true_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('v_d_error_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('p_d_pred_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('p_d_true_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.ylim([-1.0, 0.0])
        plt.tight_layout()
        plt.savefig('p_d_error_mywork_1.png', dpi=800)
        plt.show()
    ...
    def my_plot_loss(loss_epochs,loss_int_s_epochs,loss_boundary_s_epochs,\
        ...
        plt.xlabel('Epochs')
        plt.ylabel('Metrics')
        plt.savefig('Loss_mywork_1_legend_on.png', dpi=800)
        plt.show()
        ...
        plt.xlabel('Epochs')
        plt.ylabel('Metrics')
        plt.savefig('Loss_mywork_1_legend_off.png', dpi=800)
        plt.show()
        ...
        plt.xlabel('Epochs')
        plt.ylabel('L2')
        plt.savefig('L2_mywork_1_legend_on.png', dpi=800)
        plt.show()
        ...
        plt.xlabel('Epochs')
        plt.ylabel('L2')
        plt.savefig('L2_mywork_1_legend_off.png', dpi=800)
        plt.show()
        ...
        plt.xlabel('Epochs')
        plt.ylabel('L2_ab')
        plt.savefig('L2_ab_mywork_1_legend_on.png', dpi=800)
        plt.show()
        ...
        plt.xlabel('Epochs')
        plt.ylabel('L2_ab')
        plt.savefig('L2_ab_mywork_1_legend_off.png', dpi=800)
        plt.show()
        ...
        plt.xlabel('Epochs')
        plt.ylabel('a,b')
        plt.savefig('a,b_mywork_1.png', dpi=800)
        plt.show()
        ...
        plt.xlabel('Epochs')
        plt.ylabel('lr')
        plt.savefig('lr_mywork_1.png', dpi=800)
        plt.show()
...
def train():
    ...
    for epoch in range(1, 1 + epochs_adam):
        ...
        loss = loss_int_s  +  loss_int_d * K +  100 * loss_boundary_s + 100 * loss_boundary_d  +  loss_boundary_inter
        loss.backward()
        optimizer.step()
        scheduler.step(loss)
    ...
    torch.save(model, 'model_mywork_1.pth')
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    model_mywork_1 = torch.load('model_mywork_1.pth', map_location=device)
    model_mywork_1.to(device)

    filename1 = "data_mywork_1.txt"
